...
In development mode, durable progress should normally be verified git commits, not long-lived reports/artifacts. In optimization mode, record metric observations. In research mode, record sources/evidence and cycle findings.
